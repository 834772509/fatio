...
enum grub_file_type
{
	...
	GRUB_FILE_TYPE_FILTER_VDISK = 0x40000,
};
...
typedef enum grub_file_filter_id
{
	...
	GRUB_FILE_FILTER_LZ4IO,
	GRUB_FILE_FILTER_VHD,
	GRUB_FILE_FILTER_VHDX,
	GRUB_FILE_FILTER_VDI,
	GRUB_FILE_FILTER_QCOW,
	GRUB_FILE_FILTER_DMG,
	GRUB_FILE_FILTER_MAX,
	GRUB_FILE_FILTER_COMPRESSION_FIRST = GRUB_FILE_FILTER_GZIO,
	GRUB_FILE_FILTER_COMPRESSION_LAST = GRUB_FILE_FILTER_LZ4IO,
	GRUB_FILE_FILTER_VDISK_FIRST = GRUB_FILE_FILTER_VHD,
	GRUB_FILE_FILTER_VDISK_LAST = GRUB_FILE_FILTER_DMG,
...
/* Get a disk name from NAME.  */
char* EXPORT_FUNC(grub_file_get_disk_name) (const char* name);
