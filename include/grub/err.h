...
grub_err_t EXPORT_FUNC(grub_error) (grub_err_t n, _Printf_format_string_ const char *fmt, ...);
_Noreturn
void EXPORT_FUNC(grub_fatal) (_Printf_format_string_ const char *fmt, ...);
void EXPORT_FUNC(grub_error_push) (void);
int EXPORT_FUNC(grub_error_pop) (void);
void EXPORT_FUNC(grub_print_error) (void);
extern int EXPORT_VAR(grub_err_printed_errors);
int grub_err_printf (_Printf_format_string_ const char *fmt, ...);
