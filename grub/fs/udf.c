...
static grub_err_t
grub_udf_dir(grub_disk_t disk, const char* path,
...
static grub_err_t
grub_udf_label(grub_disk_t disk, char** label)
{
	struct grub_udf_data* data;
	data = grub_udf_mount(disk);
...
static grub_err_t
grub_udf_uuid(grub_disk_t disk, char** uuid)
{
	char* volset_ident;
	struct grub_udf_data* data;
	data = grub_udf_mount(disk);
